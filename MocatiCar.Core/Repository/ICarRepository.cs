...
namespace MocatiCar.Core.Repository
{
    ...
    {
        Task<(IEnumerable<Car> Cars, int TotalItems)> GetAllCarAsync(int page, int limit, string search, bool? status, string modelname, string brandname, string transmission,
             string fuelType, string location, string sortedBy, string order);
