...
namespace Moncati_Car_API.Controllers
{
    ...
    public class ReviewController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<ResultModel>> GetAll(int page = 1, int limit = 10, bool flag= false, int? rating = null)
        {
        ...
        public async Task<ActionResult<ResultModel>> GetReviewByCarId(Guid carId, int page = 1, int limit = 10,bool flag=false)
        {
        ...
        public async Task<ActionResult<ResultModel>> GetReviewByUserId(Guid userId, int page = 1, int limit = 10, bool flag = false)
        {
